...
const blocks: Block[] = [
  {
    ...
    paragraphs: [
      ...
      'Asimismo, esta Política describe con detalle la infraestructura tecnológica utilizada por Mándalo y los proveedores externos que intervienen en el tratamiento, entre ellos el proveedor de infraestructura de servidores y los servicios de Google LLC empleados para autenticación, notificaciones, correo electrónico y mapas, conforme al Capítulo III.',
      'Mándalo no vende datos personales, no muestra publicidad de terceros dentro de la aplicación y no utiliza los datos de los titulares con fines de perfilamiento comercial.',
      'El presente documento será aplicable a todas las personas que interactúen con Mándalo, incluyendo usuarios, comercios aliados, domiciliarios, representantes legales, proveedores y cualquier otro titular cuyos datos personales sean objeto de tratamiento.',
    ],
  },
  {
    heading: '1. Objeto',
    paragraphs: [
      'La presente Política tiene por objeto establecer las condiciones jurídicas, técnicas y administrativas bajo las cuales Mándalo realiza el tratamiento de los datos personales obtenidos mediante la aplicación móvil, los servicios asociados y los diferentes canales de atención habilitados. De manera específica, esta Política tiene como finalidad:',
      [
        ...
        'Definir las responsabilidades asumidas por Mándalo como Responsable del Tratamiento.',
  ...
  },
  {
    heading: '2. Alcance',
    paragraphs: [
      'La presente Política será aplicable a todas las actividades de tratamiento realizadas por Mándalo, independientemente del medio físico o electrónico mediante el cual la información sea recopilada, almacenada, utilizada, consultada, transmitida, transferida, actualizada, conservada o eliminada.',
      'La presente Política será aplicable a las siguientes categorías de titulares:',
      [
        'Los usuarios registrados en la aplicación Mándalo.',
        ...
        'Los visitantes de los sitios web oficiales de Mándalo.',
  ...
  },
  {
    ...
    paragraphs: [
      'El tratamiento de datos personales realizado por Mándalo se regirá, entre otras, por las siguientes disposiciones:',
      [
      ...
      'Adicionalmente, Mándalo adopta como referencia las mejores prácticas internacionales en materia de privacidad, incluyendo los principios de Privacy by Design, Privacy by Default, Accountability y minimización de datos.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      [
        ...
        'Base de Datos: Conjunto organizado de datos personales objeto de tratamiento por parte de Mándalo.',
        ...
        'Firebase Cloud Messaging (FCM): Servicio de Google LLC utilizado por Mándalo exclusivamente para el envío de notificaciones push a los dispositivos de los titulares.',
        ...
        'Hostinger: Proveedor de infraestructura de servidores contratado por Mándalo, que actúa como Encargado del Tratamiento respecto de la custodia técnica de la información.',
        'PostgreSQL: Sistema de gestión de bases de datos relacional instalado y administrado directamente por Mándalo en su propia infraestructura. No constituye un proveedor externo.',
        'Redis: Sistema de almacenamiento temporal en memoria instalado y administrado directamente por Mándalo. No constituye un proveedor externo.',
        'Responsable del Tratamiento: Persona natural o jurídica que decide sobre la finalidad y el tratamiento de los datos personales. Para efectos de la presente Política, el Responsable del Tratamiento es Luis Carlos Erazo Burbano, persona natural comerciante identificado con NIT 1127077851-4, quien opera bajo el nombre comercial Mándalo.',
  ...
  },
  {
    ...
    paragraphs: [
      'En todas las etapas del tratamiento de la información, Mándalo garantizará el respeto de los siguientes principios:',
      [
        ...
        '5.2 Finalidad. Los datos personales serán recopilados y tratados únicamente para finalidades legítimas, específicas, explícitas e informadas previamente al titular. Mándalo no utilizará la información para fines incompatibles con aquellos que motivaron su recolección.',
        ...
        '5.6 Seguridad. Mándalo implementará medidas técnicas, administrativas, organizacionales y procedimentales razonables para proteger los datos personales contra pérdida, alteración, destrucción, acceso no autorizado, uso indebido o divulgación accidental.',
        ...
        '5.9 Minimización de Datos. Mándalo recopilará únicamente los datos personales estrictamente necesarios para cumplir las finalidades informadas. No se solicitará información excesiva, irrelevante o desproporcionada respecto del servicio prestado.',
        '5.10 Responsabilidad Demostrada (Accountability). Mándalo adoptará políticas, procedimientos, controles internos y medidas documentales que permitan demostrar el cumplimiento efectivo de sus obligaciones legales.',
        ...
        '5.13 Necesidad y Proporcionalidad. Toda actividad de tratamiento deberá responder a una finalidad legítima y ser proporcional a los fines perseguidos. Cuando existan varias alternativas, Mándalo utilizará aquella que implique un menor impacto sobre la privacidad.',
      ],
    ],
  },
  { chapter: 'Capítulo I — Disposiciones Generales y Marco Jurídico' },
  {
    ...
    paragraphs: [
      'El presente capítulo establece las disposiciones generales que regulan el tratamiento de los datos personales realizado por Mándalo y desarrolla el marco jurídico específico bajo el cual se efectúan las actividades de recolección, almacenamiento, uso, consulta, circulación, transmisión, transferencia, conservación y supresión de información personal.',
      'Las disposiciones aquí contenidas serán de obligatorio cumplimiento para todas las personas que intervengan en el tratamiento de datos personales dentro de la operación de la plataforma, independientemente del vínculo jurídico que mantengan con Mándalo.',
    ],
  },
  {
    heading: 'Artículo 2. Responsable del Tratamiento',
    paragraphs: [
      'El Responsable del Tratamiento de los datos personales recopilados a través de la plataforma Mándalo es Luis Carlos Erazo Burbano, persona natural comerciante, identificado con cédula de ciudadanía No. 1127077851 y NIT 1127077851-4, nombre comercial Mándalo, con domicilio en Cll 10 Cr 3-14 B/ 29 de mayo, Villagarzón, Putumayo, Colombia. Correo para derechos de habeas data: mandaloputumayo@gmail.com.',
  ...
  },
  {
    ...
    paragraphs: [
      'Mándalo tratará los datos personales con el propósito de permitir el funcionamiento integral de la plataforma tecnológica y garantizar la adecuada prestación de los servicios ofrecidos a usuarios, comercios aliados y domiciliarios.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Comercios Aliados. Personas naturales o jurídicas registradas en la plataforma para ofrecer productos o servicios a los usuarios y gestionar los pedidos recibidos a través de Mándalo.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Mándalo conservará prueba de la autorización otorgada, registrando el identificador del titular, la fecha y hora, la dirección IP desde la cual se otorgó y la versión de la Política aceptada.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Mándalo podrá solicitar la actualización de la información cuando existan razones objetivas para considerar que los datos registrados han perdido vigencia o presentan inconsistencias.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'La presente Política entrará en vigor a partir de la fecha indicada en la portada y permanecerá vigente mientras Mándalo realice actividades de tratamiento de datos personales o hasta que sea sustituida por una versión posterior debidamente aprobada y publicada.',
  ...
  { chapter: 'Capítulo II — Datos Personales Recopilados y Finalidades del Tratamiento' },
  {
    ...
    paragraphs: [
      'Mándalo recopilará únicamente los datos personales necesarios para permitir el funcionamiento de la plataforma, garantizar la adecuada prestación de los servicios ofrecidos y cumplir las obligaciones legales aplicables.',
  ...
  },
  {
    ...
    paragraphs: [
      'Dependiendo del tipo de titular y de los servicios utilizados, Mándalo podrá tratar las siguientes categorías de información:',
  ...
  },
  {
    ...
    paragraphs: [
      'Con el fin de garantizar un tratamiento adecuado y proporcional, Mándalo recopilará únicamente la información necesaria según la categoría de titular.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Estos datos son procesados en la infraestructura propia de Mándalo y serán utilizados exclusivamente para fines de seguridad, mantenimiento, análisis estadístico y mejora continua del servicio. No se utilizan servicios de analítica de comportamiento de terceros.',
    ],
  },
  {
    heading: 'Artículo 16. Permisos del Dispositivo',
    paragraphs: [
      'Para garantizar el correcto funcionamiento de la plataforma, Mándalo podrá solicitar autorización para acceder a determinadas funcionalidades del dispositivo móvil. El detalle de los permisos, su finalidad y las categorías de titulares a los que aplican se encuentra en el Artículo 30 de la presente Política.',
      'Mándalo no solicita acceso al micrófono, a la lista de contactos, al calendario, a los mensajes de texto ni al registro de llamadas del dispositivo.',
  ...
  {
    heading: 'Artículo 18. Información que Mándalo No Recopila',
    paragraphs: [
      'Mándalo no recopila ni solicita las siguientes categorías de información:',
      [
      ...
      'Precisión sobre información financiera. Mándalo trata la información de cuentas bancarias suministrada voluntariamente por los comercios aliados y los domiciliarios, con la finalidad exclusiva de efectuar la dispersión de los pagos que les corresponden. Mándalo no recopila ni almacena datos de tarjetas de crédito o débito de los usuarios.',
      'En caso de que futuras funcionalidades requieran el tratamiento de alguna categoría adicional de datos personales, Mándalo actualizará la presente Política e informará previamente a los titulares, solicitando las autorizaciones que resulten legalmente exigibles.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Mándalo podrá suspender temporalmente determinadas funcionalidades o solicitar procesos adicionales de validación cuando existan indicios razonables de inconsistencias, suplantación de identidad, fraude o utilización indebida de la plataforma.',
  ...
  },
  {
    ...
    paragraphs: [
      'La plataforma Mándalo está dirigida exclusivamente a personas mayores de dieciocho (18) años. La aplicación no recopila intencionalmente datos personales de menores de edad ni permite el registro de cuentas por parte de quienes no cuenten con la capacidad legal para contratar.',
  ...
  { chapter: 'Capítulo III — Infraestructura Tecnológica, Autenticación, Notificaciones y Geolocalización' },
  {
    ...
    paragraphs: [
      'Mándalo opera mediante una aplicación móvil desarrollada en tecnología multiplataforma y una infraestructura de servidores propia, administrada directamente por el Responsable del Tratamiento.',
      'Infraestructura administrada por Mándalo:',
      [
        'Servidor de aplicaciones propio, sobre el cual se ejecuta la interfaz de programación (API) de la plataforma.',
        'Sistema de gestión de bases de datos relacional PostgreSQL, instalado y administrado por Mándalo.',
      ...
      'PostgreSQL y Redis constituyen tecnologías de software instaladas y operadas directamente por Mándalo, y no corresponden a servicios prestados por terceros ni implican la comunicación de datos personales a proveedores externos distintos del proveedor de infraestructura señalado.',
      'La utilización de los servicios anteriores no implica la venta de datos personales por parte de Mándalo, ni autoriza a los proveedores a utilizar la información para finalidades distintas de la prestación de los servicios contratados.',
    ],
  },
  {
    heading: 'Artículo 22. Alojamiento e Infraestructura de Servidores',
    paragraphs: [
      'La totalidad de la información necesaria para el funcionamiento de la plataforma se aloja en servidores contratados por Mándalo con el proveedor de infraestructura Hostinger International Ltd., sociedad constituida en la República de Lituania, en un centro de datos ubicado en Boston, Estados Unidos de América.',
      'La administración, el despliegue y la orquestación de los servicios se realizan mediante herramientas de gestión de contenedores operadas directamente por Mándalo.',
      'El proveedor de infraestructura actúa exclusivamente como Encargado del Tratamiento y su intervención se limita a la custodia técnica, la disponibilidad y la seguridad física y lógica de los servidores. Dicho proveedor no accede al contenido de la información con fines propios ni la utiliza para finalidades distintas de las instruidas por Mándalo.',
      ...
      'Mándalo conserva en todo momento la calidad de Responsable del Tratamiento y determina de manera exclusiva las finalidades y los medios del tratamiento.',
    ],
  },
  {
    heading: 'Artículo 23. Bases de Datos y Almacenamiento Temporal',
    paragraphs: [
      'La información estructurada de la plataforma se almacena en una base de datos relacional PostgreSQL administrada por Mándalo. Entre otros, podrán almacenarse: datos de identificación y contacto de usuarios, comercios aliados y domiciliarios; direcciones registradas y coordenadas geográficas asociadas; pedidos, estados de los pedidos e historial de operaciones; registros de entregas y confirmaciones; calificaciones y comentarios; registros de autenticación y eventos de seguridad; y configuración operativa de la aplicación.',
      'Adicionalmente, Mándalo utiliza un sistema de almacenamiento en memoria (Redis) para la gestión de sesiones activas, tokens de acceso, colas de procesamiento, notificaciones pendientes y datos operativos de carácter transitorio.',
  ...
  },
  {
    ...
    paragraphs: [
      'Los archivos e imágenes cargados por los titulares se almacenan directamente en la infraestructura de servidores administrada por Mándalo, sin recurrir a servicios de almacenamiento en la nube de terceros distintos del proveedor de infraestructura señalado en el Artículo 22.',
      ...
      'Mándalo revisa y refuerza periódicamente los controles aplicables a esta categoría de información, conforme a lo previsto en el Artículo 45.',
    ],
  },
  {
    heading: 'Artículo 25. Autenticación de Usuarios',
    paragraphs: [
      'Mándalo administra directamente el proceso de autenticación mediante servicios desarrollados sobre su propia infraestructura, utilizando mecanismos de identificación basados en tokens de sesión.',
      'a) Inicio de sesión con cuenta de Google. Mándalo utiliza el servicio de identidad Google Sign-In, provisto por Google LLC, que permite al titular autenticarse utilizando su cuenta de Google. Mediante este mecanismo, Mándalo podrá recibir de Google, previa autorización del titular, el nombre asociado a la cuenta, la dirección de correo electrónico, la fotografía de perfil cuando esté disponible y el identificador único de la cuenta. Mándalo no tiene acceso a la contraseña de la cuenta de Google del titular ni la almacena en ningún momento.',
      'b) Registro y verificación mediante correo electrónico. El titular podrá registrarse utilizando una dirección de correo electrónico. En este caso, Mándalo enviará a dicha dirección un código o enlace de verificación, cuya validación se realiza íntegramente en la infraestructura propia de Mándalo mediante tokens de un solo uso y vigencia limitada. Para el envío de estos correos, Mándalo utiliza el servicio de correo electrónico de Google conforme al Artículo 26. Una vez validada la identidad, la sesión del titular se administra mediante tokens generados y custodiados por la infraestructura de Mándalo.',
  ...
  },
  {
    ...
    paragraphs: [
      'Mándalo utiliza el servicio Firebase Cloud Messaging (FCM), provisto por Google LLC, con el único propósito de entregar notificaciones push a los dispositivos de los titulares.',
      ...
      'Mándalo utiliza exclusivamente el componente de mensajería de Firebase. No utiliza los servicios de Firebase Authentication, Cloud Firestore, Realtime Database, Firebase Storage, Firebase Analytics ni Firebase Crashlytics.',
    ],
  },
  {
    heading: 'Artículo 28. Google Maps Platform',
    paragraphs: [
      'Con el propósito de facilitar la prestación de los servicios, Mándalo utiliza los servicios de Google Maps Platform, provistos por Google LLC.',
  ...
  },
  {
    ...
    paragraphs: [
      'La geolocalización constituye una funcionalidad esencial para la operación de Mándalo.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Mándalo no accede a la ubicación en segundo plano de los usuarios ni de los comercios aliados.',
  ...
  },
  {
    ...
    paragraphs: [
      'La precisión de la información geográfica dependerá del dispositivo utilizado, de la disponibilidad de señal GPS, de las redes móviles, de la conexión a Internet y de otros factores técnicos ajenos al control de Mándalo.',
  ...
  },
  {
    ...
    paragraphs: [
      'Con el fin de garantizar la transparencia del tratamiento, Mándalo declara expresamente que, a la fecha de vigencia de la presente Política, la aplicación no:',
      [
  ...
  { chapter: 'Capítulo IV — Tratamiento de Datos de Usuarios, Comercios y Domiciliarios' },
  {
    ...
    paragraphs: [
      'El tratamiento de los datos personales realizado por Mándalo variará según la categoría del titular y la naturaleza de la relación que mantenga con la plataforma.',
  ...
  },
  {
    ...
    paragraphs: [
      'Mándalo tratará los datos personales de los usuarios con el propósito de permitir el acceso a la plataforma, gestionar solicitudes de pedidos, coordinar la prestación de los servicios y garantizar una experiencia segura y eficiente. Para tal efecto, los datos podrán ser utilizados para:',
      [
      ...
      'En ningún caso Mándalo utilizará los datos personales de los usuarios para finalidades distintas de las aquí previstas sin la autorización correspondiente o sin que exista un fundamento legal que lo permita.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'Con el fin de permitir la correcta ejecución de los pedidos, Mándalo compartirá determinada información entre los participantes de la operación. La información compartida está limitada al mínimo necesario para la prestación del servicio.',
      ...
      'Compartición con Operadores Parafiscales de Ley: el usuario en el rol de Domiciliario Independiente autoriza de forma expresa a Mándalo para transmitir sus datos de identificación, contacto y reportes de ingresos mensuales a los operadores de información de la Planilla Integrada de Liquidación de Aportes (PILA), Administradoras de Riesgos Laborales (ARL), Entidades Promotoras de Salud (EPS) y Fondos de Pensión, con el único fin de tramitar la cotización cofinanciada exigida por la legislación nacional.',
    ],
  },
  {
    heading: 'Artículo 39. Comunicaciones entre las Partes',
    paragraphs: [
      'Mándalo podrá habilitar mecanismos de comunicación entre usuarios, comercios y domiciliarios cuando ello resulte necesario para la adecuada ejecución del servicio.',
  ...
  },
  {
    ...
    paragraphs: [
      'Con el propósito de mejorar la calidad del servicio, Mándalo podrá permitir que los usuarios, comercios y domiciliarios se califiquen mutuamente una vez finalizado cada pedido.',
  ...
  },
  {
    ...
    paragraphs: [
      'Mándalo podrá tratar datos personales con el fin de prevenir actividades fraudulentas, proteger la integridad de la plataforma y garantizar la seguridad de todos los participantes.',
      ...
      'Cuando existan indicios razonables de fraude, uso indebido de la plataforma o incumplimiento de las condiciones de uso, Mándalo podrá adoptar medidas preventivas, incluyendo la suspensión temporal de funcionalidades o el bloqueo de cuentas, sin perjuicio del derecho del titular a presentar las aclaraciones correspondientes conforme al Artículo 14 de los Términos y Condiciones.',
    ],
  },
  {
    heading: 'Artículo 42. Conservación de Evidencias Operativas',
    paragraphs: [
      'Con el fin de atender reclamaciones, resolver controversias, responder requerimientos de autoridades competentes y garantizar la trazabilidad de las operaciones, Mándalo podrá conservar registros relacionados con: pedidos realizados; historial de entregas; registros de geolocalización asociados a pedidos ejecutados; confirmaciones de entrega; fotografías utilizadas como evidencia de entrega; registros de autenticación; eventos relevantes de seguridad; y comunicaciones relacionadas con incidentes del servicio.',
  ...
  },
  {
    ...
    paragraphs: [
      'Mándalo utiliza procesos automatizados para asignar pedidos, calcular distancias, estimar tiempos de entrega, determinar rutas y organizar la operación de la plataforma.',
      ...
      'Las decisiones automatizadas implementadas por Mándalo tienen una finalidad exclusivamente operativa y no producen efectos jurídicos independientes sobre los titulares ni sustituyen las decisiones que legalmente correspondan al Responsable del Tratamiento.',
      'Las medidas de suspensión o cancelación de cuentas no se adoptan de forma exclusivamente automatizada: toda decisión de esta naturaleza es revisada por personal de Mándalo y el titular podrá solicitar su reconsideración.',
    ],
  },
  { chapter: 'Capítulo V — Seguridad, Transferencias Internacionales y Conservación' },
  {
    ...
    paragraphs: [
      'Mándalo reconoce que la protección de los datos personales constituye un elemento esencial para la confianza de los usuarios, comercios y domiciliarios.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Las medidas implementadas serán objeto de revisión periódica y podrán modificarse de acuerdo con la evolución tecnológica y los riesgos identificados. Ningún sistema informático ofrece seguridad absoluta, por lo que Mándalo no garantiza que terceros no autorizados puedan superar las medidas implementadas, sin perjuicio de las obligaciones legales que le corresponden como Responsable del Tratamiento.',
    ],
  },
  {
    heading: 'Artículo 46. Confidencialidad',
    paragraphs: [
      'Toda persona que tenga acceso a datos personales tratados por Mándalo deberá mantener absoluta reserva sobre dicha información.',
  ...
  },
  {
    ...
    paragraphs: [
      'Cuando Mándalo tenga conocimiento de un incidente que pueda comprometer la confidencialidad, integridad o disponibilidad de los datos personales, adoptará las medidas razonables necesarias para contener el incidente, identificar su causa, evaluar el impacto generado, restablecer la disponibilidad de los servicios afectados, implementar acciones correctivas y evitar la repetición de eventos similares.',
      'Mándalo reportará los incidentes que afecten datos personales ante la Superintendencia de Industria y Comercio en los términos y plazos previstos por la legislación vigente, y comunicará a los titulares afectados cuando ello resulte necesario para la protección de sus derechos.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Mándalo conserva la calidad de Responsable del Tratamiento respecto de toda la información transferida y responde por el cumplimiento de las obligaciones que le impone la legislación colombiana.',
    ],
  },
  {
    heading: 'Artículo 49. Tratamiento por Encargados',
    paragraphs: [
      'Mándalo podrá contratar proveedores tecnológicos o prestadores de servicios que actúen como Encargados del Tratamiento.',
      'En estos casos, dichos terceros únicamente podrán tratar los datos personales conforme a las instrucciones impartidas por Mándalo y exclusivamente para las finalidades autorizadas.',
  ...
  },
  {
    ...
    paragraphs: [
      'Mándalo conservará la información conforme a los siguientes plazos, sin perjuicio de los términos superiores que establezca la legislación aplicable:',
      {
        table: {
  ...
  },
  {
    ...
    paragraphs: [
      'Cuando los datos personales dejen de ser necesarios para las finalidades que motivaron su tratamiento y no exista obligación legal de conservarlos, Mándalo procederá a su eliminación segura o, cuando resulte técnicamente viable, a su anonimización irreversible.',
  ...
  },
  {
    ...
    paragraphs: [
      'Mándalo implementa mecanismos de respaldo y recuperación con el fin de procurar la disponibilidad de la plataforma ante fallos técnicos, incidentes de seguridad o eventos que afecten la infraestructura tecnológica.',
  ...
  { chapter: 'Capítulo VI — Derechos de los Titulares, Procedimientos y Disposiciones Finales' },
  {
    ...
    paragraphs: [
      ...
      [
        'Conocer la existencia de datos personales que estén siendo tratados por Mándalo.',
        ...
        'Presentar quejas ante la Superintendencia de Industria y Comercio cuando considere que se ha vulnerado la legislación sobre protección de datos personales, una vez agotado el trámite de consulta o reclamo ante Mándalo cuando ello resulte exigible.',
  ...
  },
  {
    ...
    paragraphs: [
      'Los titulares podrán consultar la información personal que repose en las bases de datos administradas por Mándalo.',
  ...
  },
  {
    ...
    paragraphs: [
      'Los titulares podrán presentar reclamos cuando consideren que la información tratada por Mándalo deba ser corregida, actualizada o suprimida, o cuando adviertan un posible incumplimiento de las obligaciones legales relacionadas con la protección de datos personales.',
      'El reclamo será atendido en un término máximo de quince (15) días hábiles contados a partir del día siguiente a la fecha de su recibo. Cuando no fuere posible atenderlo dentro de dicho término, se informará al interesado los motivos de la demora y la fecha en que se atenderá su reclamo, la cual en ningún caso podrá superar los ocho (8) días hábiles siguientes al vencimiento del primer término.',
      'Cuando el reclamo resulte incompleto, Mándalo requerirá al interesado dentro de los cinco (5) días siguientes a su recepción para que subsane las fallas. Transcurridos dos (2) meses desde la fecha del requerimiento sin que el solicitante presente la información requerida, se entenderá que ha desistido del reclamo.',
  ...
  },
  {
    ...
    paragraphs: [
      'El titular podrá solicitar la revocatoria de la autorización otorgada para el tratamiento de sus datos personales cuando no exista un deber legal o contractual que obligue a Mándalo a continuar con dicho tratamiento.',
  ...
  },
  {
    ...
    paragraphs: [
      'Cuando no resulte posible poner a disposición del titular el texto íntegro de la presente Política, Mándalo comunicará mediante un aviso de privacidad la existencia de la misma, la forma de acceder a su contenido, las finalidades del tratamiento y los mecanismos dispuestos para el ejercicio de los derechos.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Cuando Mándalo utilice proveedores tecnológicos ubicados en otros países, el tratamiento internacional de datos personales se realizará sin perjuicio de la aplicación preferente de la legislación colombiana.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'La presente Política de Privacidad y Tratamiento de Datos Personales entra en vigor a partir de la fecha indicada en la portada del documento y permanecerá vigente mientras Mándalo realice actividades de tratamiento de datos personales o hasta que sea reemplazada por una versión posterior debidamente aprobada y publicada.',
      'Las bases de datos administradas por Mándalo tendrán una vigencia igual al tiempo en que se mantenga la finalidad que justificó su tratamiento.',
    ],
  },
  {
    heading: 'Artículo 68. Disposición Final',
    paragraphs: [
      'El tratamiento de los datos personales por parte de Mándalo se sustenta en la autorización previa, expresa e informada otorgada por el titular durante el proceso de registro, mediante la selección de la casilla específica dispuesta para tal efecto conforme al Artículo 8 de la presente Política.',
