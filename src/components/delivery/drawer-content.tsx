...
// expo-router y el drawer interno).
type Props = { navigation: { closeDrawer: () => void } };

/**
 * Sidebar del panel del repartidor (rol DELI): cabecera con avatar y nombre
 * (tocarla abre Mi perfil), navegación y cierre de sesión abajo. Espejo de
 * los sidebars de admin/negocio/cliente.
 */
export function DeliveryDrawerContent({ navigation }: Props) {
